...
const UserManagementForm = () => {
  ...
  return (
    <Layout style={{ backgroundColor: '#ffffff' }}>
      <Card title={<Title style={{ textAlign: 'center', marginBottom: '5px' }} level={2}>Gestion De Usuarios</Title>}>
        <Row xs={21} sm={12} md={12} lg={12} xl={12} xxl={12} style={{ justifyContent: 'center' }}>
      ...
      <Col xs={21} sm={12} md={12} lg={12} xl={12} xxl={12} style={{ width: '100vw', margin: '0 auto', justifyContent: 'center', alignItems: 'center' }}>
        {renderForm()}
      </Col>
      <Modal
