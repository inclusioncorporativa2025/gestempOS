...
router.post('/generarPrenomina', requireRole(ROLE_GROUPS.USER_WRITE), generarPrenominaMes);
router.post('/listarPrenominas', requireRole(ROLE_GROUPS.USER_WRITE), listarPrenominasEmpresa);
