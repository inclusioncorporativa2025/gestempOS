...
const ROLE_GROUPS = {
  ...
  /** Operativa de empresa: admin plataforma (2) con el mismo acceso que ROOT por ahora */
  COMPANY_STAFF: [ROLES.ROOT, ROLES.PLATFORM_ADMIN, ROLES.ADMIN_EMPRESA, ROLES.SUPERVISOR],
  FICHAJE: [ROLES.ROOT, ROLES.PLATFORM_ADMIN, ROLES.ADMIN_EMPRESA, ROLES.SUPERVISOR, ROLES.EMPLEADO],
  PERSONAL_LIST: [ROLES.ROOT, ROLES.PLATFORM_ADMIN, ROLES.ADMIN_EMPRESA, ROLES.SUPERVISOR, ROLES.INSPECTOR],
  USER_WRITE: [ROLES.ROOT, ROLES.PLATFORM_ADMIN, ROLES.ADMIN_EMPRESA, ROLES.SUPERVISOR],
  CONFIG: [ROLES.ROOT, ROLES.PLATFORM_ADMIN, ROLES.ADMIN_EMPRESA, ROLES.SUPERVISOR],
