...
CREATE TABLE IF NOT EXISTS usuarios_documentos_nomina (
  ...
  KEY idx_udn_usuario (empresa_id, id_usuario, fecha_baja),
  KEY idx_udn_periodo (empresa_id, periodo_anio, periodo_mes, fecha_baja),
  UNIQUE KEY uq_udn_usuario_periodo_activo (empresa_id, id_usuario, periodo_anio, periodo_mes, fecha_baja)
);
